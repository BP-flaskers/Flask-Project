...
stats_routes_bp = Blueprint('stats_routes', __name__)

# 1. 사용 중인 유저의 각 질문당 선택지 선택 비율
@stats_routes_bp.route('/stats/answer_rate_by_choice', methods=['GET'])
...
@stats_routes_bp.route('/stats/answer_count_by_question', methods=['GET'])
